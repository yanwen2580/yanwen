<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<%@page import="cn.itrip.trade.sdk.alipay.AlipayConfig" %>
...
<div id="main">
        <form name=alipayment action='/trade/api/pay' method=post target="_blank">
            <div id="body" style="clear:left">
                <dl class="content">
                    ...
                    <dt>订单名称：</dt>
                    <dd>
                        <input id="WIDsubject"  value="${orderVo.orderNo}" name="WIDsubject" />
                    </dd>
                    <hr class="one_line">
                    <dt>付款金额：</dt>
                    <dd>
                        <input id="WIDtotal_amount" value="${orderVo.payAmount}" name="WIDtotal_amount" />
                    </dd>
                    <hr class="one_line"/>
                    <dt>商品描述：</dt>
                    <dd>
                        <input id="WIDbody" name="WIDbody" VALUE="${orderVo.hotelName}" />
                    </dd>
                    <hr class="one_line">
                    <dt></dt>
                    <dd id="btn-dd">
